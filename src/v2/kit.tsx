...
export const P={blue:'#73745A',night:'#22251F',ink:'#34392E',white:'#F4EEDC',orange:'#D77539',cyan:'#C8D29C',muted:'#A5AB89',sea:'#444D40',deep:'#202A25',sand:'#D6C4A0'};
...
export const Board=React.forwardRef<SVGSVGElement,{children:React.ReactNode;bg?:string}>(({children,bg=P.blue},ref)=>{
 ...
 <defs>
 <radialGradient id="board-light" cx=".38" cy=".28" r=".9"><stop stopColor={P.white} stopOpacity=".10"/><stop offset="1" stopColor={P.night} stopOpacity=".16"/></radialGradient>
 <pattern id="paper-grain" width="137" height="113" patternUnits="userSpaceOnUse">{Array.from({length:35},(_,i)=><circle key={i} cx={(i*37+11)%137} cy={(i*29+7)%113} r={i%3===0?.8:.45} fill={P.white} opacity=".35"/>)}</pattern>
 <pattern id="engraving" width="10" height="10" patternUnits="userSpaceOnUse" patternTransform="rotate(28)"><path d="M0 0V10" stroke={P.white} strokeOpacity=".08" strokeWidth="1"/></pattern>
 <linearGradient id="steel" x1="0" x2="1"><stop stopColor="#4D554C"/><stop offset=".4" stopColor="#DCE0D1"/><stop offset=".55" stopColor="#919A86"/><stop offset="1" stopColor="#333E35"/></linearGradient>
 ...
 <rect width={W} height={H} fill="url(#board-light)"/>
 {children}
 <rect width={W} height={H} fill="url(#paper-grain)" pointerEvents="none"/>
 </svg></AbsoluteFill>;
});
...
export const Phone:React.FC=()=> <g>
 ...
 <rect x="-107" y="-125" width="142" height="65" rx="19" fill="#E0E2CD"/><path d="M-86-102H6M-86-85H-10" stroke={P.muted} strokeWidth="8" strokeLinecap="round"/>
 ...
 <rect x="-109" y="197" width="218" height="37" rx="18" fill="#E0E2CD"/><circle cx="87" cy="215" r="12" fill={P.blue}/><path d="M-38 253H38" stroke={P.night} strokeWidth="5" strokeLinecap="round"/>
 <path d="M-155-183V-120M-155-95V-42M155-130V-55" stroke={P.muted} strokeWidth="5" strokeLinecap="round"/>
 </g>;
export const CloudShape:React.FC=()=> <g><path d="M-260 100C-340 100-350-25-267-51C-274-196-53-232 12-125C122-217 285-90 241 5C350 24 327 149 241 153H-230Z" fill={P.night} opacity=".2" transform="translate(14 23)"/><path d="M-260 100C-340 100-350-25-267-51C-274-196-53-232 12-125C122-217 285-90 241 5C350 24 327 149 241 153H-230Z" fill={P.white}/><path d="M-250 64H183" stroke="#DDDCC4" strokeWidth="23" strokeLinecap="round"/></g>;
...
export const Ship:React.FC=()=> <g>
 ...
 <path d="M106 38V-81H242L253 38Z" fill="#DDDCC4" stroke={P.night} strokeWidth="4"/><path d="M84-87H253V-66H84Z" fill="#DDDCC4" stroke={P.night} strokeWidth="4"/><path d="M138-106H221V-87H138Z" fill="#DDDCC4" stroke={P.night} strokeWidth="4"/>
 ...
 <path d="M-287 39V-109H-192V-92H-265V39" fill="#DDDCC4" stroke={P.night} strokeWidth="4"/><path d="M-240-94-202 25M-272-94-289 25" stroke={P.orange} strokeWidth="10"/>
...
export const Seabed:React.FC<{W:number;H:number}> =({W,H})=><g>
 <path d={'M-400 '+H*.76+'Q'+W*.13+' '+H*.57+' '+W*.46+' '+H*.8+'T'+(W+400)+' '+H*.7+'V'+(H+400)+'H-400Z'} fill="#404B3E"/>
 <path d={'M-400 '+H*.86+'Q'+W*.18+' '+H*.73+' '+W*.51+' '+H*.88+'T'+(W+400)+' '+H*.79+'V'+(H+400)+'H-400Z'} fill="#56614B"/>
