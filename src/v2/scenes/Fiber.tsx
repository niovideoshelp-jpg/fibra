...
export const Fiber:React.FC=()=>{
 ...
 .to(s('[data-jacket]'),{x:-220,rotation:-30,duration:.8,ease:'power3.inOut'},2.1)
 .to(s('[data-armor]'),{x:-115,rotation:35,duration:.8,ease:'power3.inOut'},2.2)
 .to(s('[data-copper]'),{x:20,duration:.8,ease:'power3.inOut'},2.3)
 .to(s('[data-liner]'),{x:75,duration:.8,ease:'power3.inOut'},2.35)
 .to(s('[data-fiber-group]'),{x:145,rotation:30,duration:.8,ease:'power3.inOut'},2.4)
