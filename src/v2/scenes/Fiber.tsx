...
export const Fiber:React.FC=()=>{
 ...
 t.from(s('[data-photo]'),{x:W*.4,rotation:-18,scale:.6,opacity:0,duration:.6,ease:'power3.out'},0)
 .to(s('[data-photo]'),{scale:1.8,x:-W*.3,opacity:0,duration:.8,ease:'power3.in'},1)
 .from(s('[data-face]'),{scale:.05,rotation:-80,opacity:0,duration:.8,ease:'power3.out',svgOrigin:'0 0'},1.1)
 .to(s('[data-jacket]'),{x:-220,rotation:-30,svgOrigin:'0 0',duration:.8,ease:'power3.inOut'},2.1)
 .to(s('[data-armor]'),{x:-115,rotation:35,svgOrigin:'0 0',duration:.8,ease:'power3.inOut'},2.2)
 .to(s('[data-copper]'),{x:20,duration:.8,ease:'power3.inOut'},2.3)
 .to(s('[data-liner]'),{x:75,duration:.8,ease:'power3.inOut'},2.35)
 .to(s('[data-fiber-group]'),{x:145,rotation:30,svgOrigin:'0 0',duration:.8,ease:'power3.inOut'},2.4)
 .to(s('[data-face]'),{scale:3.4,x:-420,opacity:0,duration:.65,ease:'power3.in',svgOrigin:'0 0'},4.1)
 ...
 <g transform={'translate('+W/2+' '+H/2+')'}><g data-photo><image href={staticFile('images/cable.png')} x={p?-570:-640} y="-400" width={p?1140:1280} height={p?760:853}/></g><g data-face transform={'scale('+(p?1.28:1.4)+')'}><CableFace/></g></g>
