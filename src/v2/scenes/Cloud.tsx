...
export const Cloud:React.FC=()=>{
 ...
 .to(s('[data-cloud-top]'),{y:-H*.13,scale:.94,opacity:0,duration:1.5,ease:'power3.inOut',svgOrigin:cx+' '+cy},4.9)
 .from(s('[data-water]'),{y:H*.7,duration:1.5,ease:'power3.inOut'},4.9)
 .from(s('[data-world]'),{opacity:0,y:H*.12,scale:.94,duration:1.2,ease:'power3.out',svgOrigin:W/2+' '+H*.52},6)
 ...
 .to(s('[data-world]'),{rotation:0,scale:1.07,y:-H*.015,duration:4.2,svgOrigin:W/2+' '+H*.52,ease:'power1.inOut'},9);
 });
 ...
 <g data-world><g transform={'translate('+(W/2-500*sc)+' '+(H*.52-250*sc)+') scale('+sc+')'}>
