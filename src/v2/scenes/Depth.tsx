...
export const Depth:React.FC=()=>{
 ...
 .to(s('[data-underwater]'),{x:-W*.04,y:-H*.13,scale:1.17,duration:6.1,ease:'sine.inOut',svgOrigin:W/2+' '+H*.75},3.8)
 ...
 <Seabed W={W} H={H}/><path d={d} stroke="#20251F" strokeWidth="28" fill="none"/><path d={d} stroke="#8D9679" strokeWidth="14" fill="none"/>
