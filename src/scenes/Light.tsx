...
export const Light:React.FC=()=>{
 ...
 .to(selector('[data-cable]'),{scale:1.025,duration:6},1.3)
 ...
 <Img data-cable src={staticFile('images/cable.png')} style={{position:'absolute',width:p?1000:1120,left:p?40:740,top:p?660:230}}/>
