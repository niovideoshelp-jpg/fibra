...
const frames=[60,210,375,520,810,1220,1385,1720,1940,2205,2450,2820,3070,135,270,1840,2030,619,1013,1510,2540,2940,1450,1750,2500,2890];
const results=[];
for(const id of ['FibraHorizontal','FibraVertical']){
 ...
 for(let i=0;i<frames.length;i++){
  ...
  results.push({file,frame:frames[i],composition:id});console.log('RENDERED '+file);
 }
}
